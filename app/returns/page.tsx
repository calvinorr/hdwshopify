...
export const metadata: Metadata = {
  ...
  description: "Returns and refunds policy for Herbarium Dyeworks.",
};
  ...
  return (
    <div className="prose prose-neutral max-w-none font-body">
      ...
      <p className="text-muted-foreground mb-4">
        ...
        you&apos;re not satisfied, you may return unused items in their original
        condition within 14 days of delivery for a full refund.
      </p>
